...
const seeds: PortSeed[] = [
  ...
  },
  {
    ...
    summary:
      'Sicilian port on the Optimed rotation, at the crossing between the two Mediterranean basins.',
    services: ['optimed'],
    capabilities: CONTAINER_AND_RORO,
  },
  {
  ...
  },
  {
    ...
    capabilities: CONTAINER_AND_RORO,
    reviewNote:
      'Published on the legacy site as "Port of Algier". Correct English name is Algiers.',
  },
  {
    slug: 'oran',
    city: 'Oran',
